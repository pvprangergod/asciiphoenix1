(function (app) {
    ...
    app.loop = function () {
		...
		for(var i = 0; i < colordata.length; i = i+4)
		{
			...
			if(gray < 3.64) character = " "; //almost white
			...
			else if(gray < 36.43) character = "I";
			else if(gray < 40.07) character = "l";
			else if(gray < 43.71) character = "!";
			else if(gray < 47.36) character = "i";
			else if(gray < 51) character = ">";
			else if(gray < 54.64) character = "<";
			else if(gray < 58.28) character = "~";
			else if(gray < 61.93) character = "+";
			else if(gray < 65.57) character = "_";
			else if(gray < 69.21) character = "-";
			else if(gray < 72.86) character = "?";
			else if(gray < 76.5) character = "]";
			else if(gray < 80.14) character = "[";
			else if(gray < 83.78) character = "}";
			else if(gray < 87.43) character = "{";
			else if(gray < 91.07) character = "1";
			...
			else if(gray < 120.21) character = "j";
			else if(gray < 123.86) character = "r";
			else if(gray < 127.5) character = "x";
			else if(gray < 131.14) character = "n";
			else if(gray < 134.78) character = "u";
			else if(gray < 138.43) character = "v";
			else if(gray < 142.07) character = "c";
			else if(gray < 145.71) character = "z";
			else if(gray < 149.35) character = "X";
			else if(gray < 153) character = "Y";
			else if(gray < 156.64) character = "U";
			else if(gray < 160.28) character = "J";
			else if(gray < 163.93) character = "C";
			else if(gray < 167.57) character = "L";
			else if(gray < 171.21) character = "Q";
			else if(gray < 174.85) character = "0";
			else if(gray < 178.5) character = "O";
			else if(gray < 182.14) character = "Z";
			else if(gray < 185.78) character = "m";
			else if(gray < 189.43) character = "w";
			else if(gray < 193.07) character = "q";
			else if(gray < 196.71) character = "p";
			else if(gray < 200.35) character = "d";
			else if(gray < 204) character = "b";
			else if(gray < 207.64) character = "k";
			else if(gray < 211.28) character = "h";
			else if(gray < 214.93) character = "a";
			else if(gray < 218.57) character = "o";
			else if(gray < 222.21) character = "*";
			else if(gray < 225.85) character = "#";
			else if(gray < 229.5) character = "M";
			else if(gray < 233.14) character = "W";
			else if(gray < 236.78) character = "&";
			else if(gray < 240.42) character = "8";
